...
save val_case1_results.mat

%%  Analysis
clear
clc
load val_case1_results.mat
...
set(gca, 'color', 'none');                                                  % To remove background
set(gcf,'units','pixels','position',[1000 300 500 500]);                    % To change the size of the figure
title("Smallest eigenvalue (\lambda_1) vs. no. of grains")
...
%% Directional Young's Modulus
f1 = figure('Name',"Directional Young's Modulus",'NumberTitle','off');
Polycrystal.PlotDYM3d(Csc(:,:,1))
title('1000 grains')
c = colorbar;
c.Label.String = "Directional Young's Modulus in GPa";
...
grid off
axis off
exportgraphics(f1,'isoDYM1.png','Resolution',500,'BackgroundColor','none');
...
grid off
axis off
exportgraphics(gcf,'isoDYM2.png','Resolution',500,'BackgroundColor','none');
...
grid off
axis off
exportgraphics(gcf,'isoDYM3.png','Resolution',500,'BackgroundColor','none');
...
grid off
axis off
exportgraphics(gcf,'isoDYM4.png','Resolution',500,'BackgroundColor','none');
...
grid off
axis off
exportgraphics(gcf,'isoDYM5.png','Resolution',500);
